                ...
                <div class="main-card mb-3 card">
                    <div class="card-body">
                        ...
                        <a class="mb-2 mr-2 btn btn-success" style="color: white;"
                            href="<?=base_url('admin/puskesmas/tambahRujukan1')?>">Tambah</a>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a href="<?=site_url('admin/puskesmas/edit_form/' . $value->id_rujukan)?>"
                                            class="btn btn-small text-warning"><i class="fas fa-edit"></i> Edit</a>

                                        <a href="<?=site_url('admin/puskesmas/delete/' . $value->id_rujukan);?>"
