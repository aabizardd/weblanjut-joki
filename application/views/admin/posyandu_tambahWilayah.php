                ...
                <div class="main-card mb-3 card">
                    <div class="card-body">
                        ...
                        <form class="" action="<?=base_url('admin/posyandu/addWilayah')?>" method="post">
                            <div class="form-row">
                                <div class="col-md-6">
                                    <div class="position-relative form-group"><label for="exampleEmail11" class="">Nama
                                            Wilayah</label><input name="nama_wilayah" id="exampleEmail11" type="text"
                                            class="form-control" required></div>
                                </div>
                                <div class="col-md-6">
                                    <div class="position-relative form-group"><label for="examplePassword11"
                                            class="">Kelurahan</label><input name="kelurahan" id="examplePassword11"
                            ...
                            <div class="form-row">
                                <div class="col-md-6">
                                    <div class="position-relative form-group"><label for="exampleCity"
                                            class="">RW</label><input name="rw" id="exampleCity" type="text"
                                            class="form-control" required></div>
                                </div>
                                <div class="col-md-6">
                                    <div class="position-relative form-group"><label for="exampleState"
                                            class="">RT</label><input name="rt" id="exampleState" type="text"
                                            class="form-control" required></div>
                                </div>
                            </div>
                            <div class="form-row">
                                <div class="col-md-6">
                                    <div class="position-relative form-group"><label for="exampleState" class="">Nama
                                            Posyandu</label><input name="nama_posyandu" id="exampleState" type="text"
                                            class="form-control" required></div>
                                </div>
                            </div>
