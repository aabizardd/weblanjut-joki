        ...
        <div class="app-page-title">
            <div class="page-title-wrapper">
                <div class="page-title-heading">
                    ...
                    <div>Data Pemeriksaan Pasien (Puskesmas)</div>
                </div>
            </div>
        </div>
        <div class="row">
            <div class="col-sm">
                <a href="<?=base_url('admin/puskesmas/pasienRujukan')?>" class="btn btn-danger mb-2"><i
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><a href="<?php echo site_url('admin/posyandu/laporanDetail/' . $data->no_pasien) ?>"
                                        ...
                                        <a href="<?=base_url("admin/puskesmas/tambahRujukan2/") . $data->id_pencatatan?>"
