                ...
                <div class="main-card mb-3 card">
                    ...
                    <div class="card-body">
                        ...
                        <a class="mb-2 mr-2 btn btn-success" style="color: white;"
                            href="<?=base_url('admin/posyandu/tambahRujukan1')?>">Tambah</a>
    ...
    $no++;?>
                                ...
                                <?=$pasienrujukan->rumahsakit;?>
                                    ...
                                    <td>
                                        ...
                                        <a href="<?=site_url('admin/posyandu/edit_form/' . $pasienrujukan->id_rujukan)?>"
                                            class="btn btn-small text-warning"><i class="fas fa-edit"></i> Edit</a>

                                        <a href="<?=site_url('admin/posyandu/delete/' . $pasienrujukan->id_rujukan);?>"
