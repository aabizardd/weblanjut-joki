                                ...
                                <div class="row">
                                    ...
                                    <div class="col">
                                        <div class="form-group row">
                                            <div class="col-sm-7">
                                                <div class="form-group row">
                                                    <label for="no_pasien" class="col-sm-2 col-form-label">No
                                                        Pasien</label>
                                                    <div class="col-sm-9">
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col">
                                                        <input name="nama_ibu" type="text" class="form-control"
                                                            ...
                                                            value="<?php echo $pendaftaran->nama_ibu ?>">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col">
                                        <div class="form-group row">
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <input name="nama_anak"
                                                            value="<?php echo $pendaftaran->nama_anak ?>" type="text"
                                            ...
                                            <div class="col-sm-5">
                                                <div class="form-group row">
                                                    <label for="p_ibu" class="col-sm-3 col-form-label">Pekerjaan
                                                        Ibu</label>
                                                    <div class="col">
                                                        <input name="p_ibu" type="text" class="form-control" id="p_ibu"
                                                            placeholder="Masukan Pekerjaan Ibu"
                                                            value="<?php echo $pendaftaran->p_ibu ?>">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-4">
                                                        <input name="tempat_lahir" id="tempat_lahir" type="text"
                                                            ...
                                                            value="<?php echo $pendaftaran->tempat_lahir ?>">
                                                    </div>
                                                    <div class="col-sm-5">
                                                        <input name="tanggal_lahir" id="tanggal_lahir" type="date"
                                                            class="form-control" placeholder="Last name"
                                                            value="<?php echo $pendaftaran->tanggal_lahir ?>">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-sm-5">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col">
                                                        <input name="nama_ayah" type="text" class="form-control"
                                                            ...
                                                            value="<?php echo $pendaftaran->nama_ayah ?>">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col">
                                        <div class="form-group row">
                                            <div class="col-sm-7">
                                                <div class="form-group row">
                                                    <label for="ttl" class="col-sm-2 col-form-label">Jenis
                                                        Kelamin</label>
                                                    <div class="col-sm-9">
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col">
                                                        <input name="p_ayah" type="text" class="form-control"
                                                            ...
                                                            value="<?php echo $pendaftaran->p_ayah ?>">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <textarea name="alamat" class="form-control" id="alamat"
                                                            rows="3"
                                                            placeholder="Masukan Alamat"><?php echo $pendaftaran->alamat ?></textarea>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-sm-5">
                                                <div class="form-group row">
                                                    <label for="tgl_daftar" class="col-sm-3 col-form-label">Tanggal
                                                        Daftar</label>
                                                    <div class="col">
                                                        <input name="tgl_daftar" class="form-control" type="text"
                                                ...
                                                <div class="form-group row">
                                                    <div class="col">
                                                        <input type="submit"
                                                            class="btn btn-success btn-user btn-block form-control-user"
