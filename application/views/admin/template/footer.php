...
<div class="modal fade bd-example-modal-lg" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true" id="modal-tambah-petugas">
...
<script>
    ...
    $(function() {
        ...
        $('#addPekerjaanP').on('click', function() {
            const url = "<?= base_url('admin/posyandu/addKategori/pekerjaan'); ?>";
