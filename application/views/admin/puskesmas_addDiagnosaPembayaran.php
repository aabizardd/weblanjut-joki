        <div class="app-main__outer">
            <div class="app-main__inner">
                ...
                <form action="<?=site_url('admin/puskesmas/add_pemeriksaan2/')?>" enctype="multipart/form-data"
                    method="POST">
                            ...
                            <div class="card-body">
                                <div class="container">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-4">
                                                    <input type="text" class="form-control" id="nama-pasien"
                                                        value="<?=$pemeriksaan_pasien['nama']?>" readonly>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <button type="button" class="btn mr-2 mb-2 btn-primary" data-toggle="modal"
                                        data-target=".bd-example-modal-lg">Bayar</button>
