...
?>
                        <tr>
                            ...
                            <td width="250">
                                <a href="<?php echo site_url('admin/posyandu/tambahPencatatan2/' . $data->no_pasien) ?>"
                                    class="btn btn- text-info"><i class="fas fa-edit"></i> Catat</a>
                            </td>
                        </tr>
                        <?php endforeach;?>
                    </tbody>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <a href="<?php echo site_url('posyandu/Pencatatan') ?>"><button type="button"
                        class="btn btn-danger">Batal</button></a>
                <a href="<?php echo site_url('posyandu/pasienrujukan') ?>"><button type="button"
                        class="btn btn-primary">Lanjut</button></a>
            </div>
        </div>
    </div>
</div>
