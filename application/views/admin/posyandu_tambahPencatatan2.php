<div class="app-main__outer">
    <div class="app-main__inner">
        ...
        <a href="<?=base_url('admin/posyandu/tambahPencatatan1')?>" class="btn btn-danger mb-2"><i
                class="fas fa-arrow-left"></i> Kembali</a>

        <div class="card-body" style="background-color:#2980b9; color: white">
            <form action="<?php echo site_url('admin/posyandu/addPencatatan_medis/') ?>" method="post"
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-8">
                                        <input type="text" class="form-control" name="no_pasien"
                                            value="<?=$pasien['no_pasien']?>" readonly>
                                    </div>
                                </div>
                            </div>
                            <div class="col-sm-6">
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-8">
                                        <input type="text" class="form-control" id="formGroupExampleInput"
                                            placeholder="Nama Pasien" readonly value="<?=$pasien['nama_anak']?>">
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            <div class="col-sm-12">
                                <div class="form-group row">
                                    ...
                                    <div class="col">
                                        <input type="number" class="form-control" name="umur" id="formGroupExampleInput"
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-6">
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-6">
                                        <input type="number" class="form-control" name="bb" id="formGroupExampleInput"
