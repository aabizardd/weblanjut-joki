            ...
            <div class="col-sm">
                ...
                <div class="main-card mb-3 card">
                    ...
                    <div class="card-body">
                        ...
                        <form class="" action="<?=base_url('admin/puskesmas/ubahPetugas')?>" method="post"
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <input
                                        class="form-control <?php echo form_error('id_petugas') ? 'is-invalid' : '' ?>"
                                        type="number" name="id_petugas" placeholder="ID Petugas"
