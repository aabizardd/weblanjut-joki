    ...
    <div class="card mb-3">
        ...
        <div class="card-body" style="background-color:#2980b9; color: white">
            <div class="container">
                ...
                <form action="<?=site_url('puskesmas/ibuhamil/pemeriksaan/edit_save/' . $pemeriksaan->id_pemeriksaan)?>"
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-6">
                                    <input type="number" class="form-control" id="usia_kehamilan" name="usia_kehamilan"
                                        placeholder="Usia Kehamilan" value="<?=$pemeriksaan->usia_kehamilan?>">
                                </div>
                                <label class="col-form-label">Bulan</label>
                            </div>
                            <div class="form-group row">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-2">
                            <button type="button" class="btn btn-success" data-toggle="modal" id="btn-diagnosa"
                                data-target="#diagnosaModal">Diagnosa</button>
                        </div>
                    </div>
            </div>
        </div>
