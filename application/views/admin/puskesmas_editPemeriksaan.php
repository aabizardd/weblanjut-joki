<div class="app-main__outer">
    <div class="app-main__inner">
        ...
        <a href="<?=base_url('admin/puskesmas/pemeriksaanIbuHamil')?>" class="btn btn-danger mt-2 mb-2"><i
                    ...
                    <div class="card-body">
                        ...
                        <div class="card-body">
                            ...
                            <button type="button" class="btn mr-2 mb-2 btn-primary" data-toggle="modal"
                                data-target="#pemeriksaanModal">Large modal</button>
                    ...
                    <div class="card-body">
                        ...
                        <div class=" card-body">
                            ...
                            <p class="card-text">Some quick example text to build on the card title and make up the bulk
                                of the card's content.</p>
                            <button type="button" class="btn mr-2 mb-2 btn-primary" data-toggle="modal"
                                data-target="#diagnosisModal">Large modal</button>
                        </div>
                    ...
                    <div class="card-body">
                        ...
                        <div class="card-body">
                            ...
                            <p class="card-text">Some quick example text to build on the card title and make up the bulk
                                of the card's content.</p>
                            <button type="button" class="btn mr-2 mb-2 btn-primary" data-toggle="modal"
                                data-target="#pembayaranModal">Large modal</button>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div class="modal-dialog modal-xl">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLongTitle">Modal Pemeriksaan</h5>
