                            ...
                            <div class="form-row">
                                <div class="col-md-6">
                                    <div class="position-relative form-group"><label for="exampleEmail11" class="">ID
                                            Jadwal</label><input name="id_jadwal" id="exampleEmail11" type="text"
                                            class="form-control" required></div>
                                </div>
                                <div class="col-md-6">
                                    <div class="position-relative form-group"><label for="examplePassword11"
                                            class="">Nama Petugas</label><input name="nama_petugas"
                                            id="examplePassword11" type="text" class="form-control" required></div>
                                </div>
                            </div>
                            <div class="form-row">
                                <div class="col-md-6">
                                ...
                                <div class="col-md-6">
                                    <div class="position-relative form-group"><label for="exampleZip"
                                        ...
                                        <select class="mb-2 form-control" name="wilayah" required>
                                            ...
                                            <option value="<?=$value['nama_wilayah']?>"><?=$value['nama_wilayah']?>
                                            </option>
                                            <?php }?>
                                        </select>
                                    </div>
