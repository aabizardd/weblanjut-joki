                ...
                <div class="main-card mb-3 card">
                    <div class="card-body">
                        ...
                        <a class="mb-2 mr-2 btn btn-success" style="color: white;"
                            href="<?=base_url('admin/posyandu/tambahPencatatan1')?>">Tambah</a>
                        <a href="<?=base_url('admin/posyandu/kelolaKategori')?>"
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><a href="<?php echo site_url('admin/posyandu/laporanDetail/' . $data->no_pasien) ?>"
                                        ...
                                        <a href="<?php echo site_url('admin/posyandu/editPencatatan/' . $data->id_pencatatan) ?>"
