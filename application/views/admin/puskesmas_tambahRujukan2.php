<div class="app-main__outer">
    <div class="app-main__inner">
        ...
        <a href="<?=base_url('admin/puskesmas/tambahRujukan1')?>" class="btn btn-danger mb-2"><i
                class="fas fa-arrow-left"></i> Kembali</a>
        <div class="card-body" style="background-color:#2980b9; color: white">
            <form action="<?php echo site_url('admin/puskesmas/addRujukan/') ?>" method="post"
            ...
            Looks Good
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control <?php echo form_error('puskesmas') ? 'is-invalid' : '' ?>"
                            type="text" name="puskesmas" placeholder="Puskesmas" required>
                        <div class="invalid-feedback">
            ...
            <?php echo form_error('rumahsakit') ?>
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control <?php echo form_error('poli') ? 'is-invalid' : '' ?>" type="text"
                            name="poli" placeholder="Poli" required>
                        <div class="invalid-feedback">
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control <?php echo form_error('umur') ? 'is-invalid' : '' ?>" type="text"
                            name="umur" placeholder="Umur" value="<?=$pencatatan['umur']?> Bulan" readonly>
                        <div class="invalid-feedback">
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="form-control <?php echo form_error('alamat') ? 'is-invalid' : '' ?>"
                            id="alamat" name="alamat" placeholder="Alamat Lengkap" rows="3"
                            readonly><?=$pencatatan['alamat']?></textarea>
                        <div class="invalid-feedback">
