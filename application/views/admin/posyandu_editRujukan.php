<div class="app-main__outer">
    <div class="app-main__inner">
        ...
        <div class="card-header">
            ...
            <a href="<?php echo site_url('admin/posyandu/pasienRujukan') ?>"><i class="fas fa-arrow-left"></i>
                Kembali</a>
        </div>
        <div class="card-body" style="background-color:#fff; color: black">
            <form action="<?php echo site_url('admin/posyandu/rujukan_edit_save/' . $pasienrujukan->id_rujukan) ?>"
                method="post">
