<div class="app-main__outer">
    <div class="app-main__inner">
        ...
        <div class="card-header">
            ...
            <a href="<?php echo site_url('admin/puskesmas/pasienRujukan') ?>"><i class="fas fa-arrow-left"></i>
                Kembali</a>
        </div>
            ...
            <form action="<?php echo site_url('admin/puskesmas/rujukan_edit_save/' . $pasienrujukan->id_rujukan) ?>"
                ...
                <div class="form-group">
                    ...
                    <input class="form-control <?php echo form_error('kab_kota') ? 'is-invalid' : '' ?>" type="text"
                        name="kab_kota" placeholder="Kabupaten/Kota" value="<?=$pasienrujukan->kab_kota;?>" required>
                    <div class="invalid-feedback">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control <?php echo form_error('poli') ? 'is-invalid' : '' ?>" type="text"
                        name="poli" placeholder="Poli Yang Dituju" value="<?=$pasienrujukan->poli;?>" required>
                    <div class="invalid-feedback">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control <?php echo form_error('namapasien') ? 'is-invalid' : '' ?>" type="text"
                        name="namapasien" placeholder="Nama Pasien" value="<?=$pasienrujukan->namapasien;?>" required />
                    <div class="invalid-feedback">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control <?php echo form_error('umur') ? 'is-invalid' : '' ?>" type="text"
                        name="umur" placeholder="Umur" value="<?=$pasienrujukan->umur;?>" required>
                    <div class="invalid-feedback">
                ...
                <div class="form-group">
                    ...
                    <textarea class="form-control <?php echo form_error('alamat') ? 'is-invalid' : '' ?>" id="alamat"
                        name="alamat" placeholder="Alamat" rows="3" required><?=$pasienrujukan->alamat;?></textarea>
                    <div class="invalid-feedback">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control <?php echo form_error('nopasien') ? 'is-invalid' : '' ?>" type="text"
                        name="nopasien" placeholder="No Pasien" value="<?=$pasienrujukan->nopasien;?>" required>
                    <div class="invalid-feedback">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control <?php echo form_error('tgl_pembuatan') ? 'is-invalid' : '' ?>"
                        ...
                        value="<?=$pasienrujukan->tgl_pembuatan;?>" required>
                    <div class="invalid-feedback">
